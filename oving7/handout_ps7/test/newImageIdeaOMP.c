...
int main(int argc, char** argv) {
	...
	performNewIdea(imageSmall, imageUnchanged, 2);

	
	// Process the small case:
	performNewIdea(imageBig, imageUnchanged,3);
	...
	performNewIdea(imageSmall, imageUnchanged, 5);
	...
	performNewIdea(imageBig, imageUnchanged, 8);
